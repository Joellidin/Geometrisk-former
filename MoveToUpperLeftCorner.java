 ...
 * @throws IllegalPositionException 
  ...
  public static void main( String[] args ) throws IllegalPositionException {
      Square newSquare = new Square(0, 0, 20, Color.black);
      Rectangle newRect = new Rectangle(1, 1, 20, 20, Color.black);
      Line newLine = new Line(0, 0, 20, 20, Color.black);
      Line newLine1 = new Line(0, 0, 20, 21, Color.black);
      Line newLine2 = new Line(0, 21, 20, 0, Color.black);
      System.out.println(newRect.equals(newRect));
      System.out.println(newLine.equals(newRect));
      System.out.println(newRect.equals(newLine));
      System.out.println(newRect.hashCode());
      System.out.println(newSquare.hashCode());
      System.out.println(newLine.hashCode());
      System.out.println(newLine1.hashCode());
      System.out.println(newLine2.hashCode());
      System.out.println(newLine1.equals(newLine2));
      System.out.println(newLine.equals(newLine));
